...
class DatabaseHelper {
  ...
  Future<Database> _initDb() async {
    ...
    String path = dir.path + 'todo_lists.db';
    final todoListDb =
  ...
  void _createDb(Database db, int version) async {
    await db.execute(
        'CREATE TABLE $taskTable($colId INTEGER PRIMARY KEY AUTOINCREMENT, $colTitle TEXT, $colDesc TEXT, $colDate TEXT, $colStatus INTEGER)');
  }
